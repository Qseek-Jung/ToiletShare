...
const MyPage: React.FC<MyPageProps> = ({
    ...
    return (
        <TextLayout className="p-0 pb-48 relative">
            ...
            {/* Header - Redesigned */}
            <div className="bg-surface dark:bg-surface-dark px-4 pb-3 pt-3 flex items-center justify-between sticky top-0 z-20 border-b border-border dark:border-border-dark shadow-sm">
