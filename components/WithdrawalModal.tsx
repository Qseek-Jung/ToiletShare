            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-sm p-6 shadow-2xl text-center relative overflow-hidden">
                ...
                {step === 'reason' && (
                    <div className="animate-in slide-in-from-right">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">탈퇴 사유를 알려주세요</h3>
                        <p className="text-sm text-gray-500 mb-6">더 나은 서비스를 만드는데 도움이 됩니다.</p>
                ...
                {step === 'confirm' && (
                    <div className="animate-in slide-in-from-right py-4">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">정말 떠나시나요?</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                            탈퇴 시 모든 적립 포인트가 소멸되며<br />
                            복구할 수 없습니다. 😢
                        </p>
